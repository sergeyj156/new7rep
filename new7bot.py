...
API_TOKEN = '6989977246:AAGgGce4PTEWu9ReQYm9Ws1rQIeEJWgpYWo'
...
async def show_main_menu(chat_id):
    ...
    photo_path = 'fotofiz/Frame 28.jpg'
...
async def invite_friend(call: types.CallbackQuery):
    ...
    invite_link = f'https://t.me/tutor_100ballniy_physics_bot?start={call.from_user.id}'
...
async def join_channels_and_chats(call: types.CallbackQuery):
    ...
    join_button_url = "https://t.me/addlist/P-X6DcPb2w03YjQy "
